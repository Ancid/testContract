...
describe("Clipcoin tests", function () {
  it("Deployment should assign the total supply of tokens to the owner", async function () {
    ...
    console.log(process.env.ROUTER02)

    const GiversToken = await ethers.getContractFactory("GiversChain");
    const hardhatToken = await GiversToken.deploy(addr1.getAddress(), addr2.getAddress(), process.env.ROUTER02);

    await hardhatToken.wait()
